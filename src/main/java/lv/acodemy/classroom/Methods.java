...
public class Methods {
    public static void main(String[] args) {
        printText("My name is Zhanete", 5);
        printText("Hello World");
       String zhaneteStory = myStory(" Zhanete", "Klimovicha", 36);
        System.out.println(myStory(" John", "Smith", 33));
        System.out.println(zhaneteStory);
    }
